<?php
	...
	$ecommerce_watch_store_align_footer_social_icon = get_theme_mod('ecommerce_watch_store_align_footer_social_icon');
	if($ecommerce_watch_store_align_footer_social_icon != false){
		$ecommerce_watch_store_custom_css .='.copyright .widget{';
			$ecommerce_watch_store_custom_css .='text-align: '.esc_attr($ecommerce_watch_store_align_footer_social_icon).';';
		$ecommerce_watch_store_custom_css .='}';
		$ecommerce_watch_store_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	if($ecommerce_watch_store_resp_menu_toggle_btn_bg_color != false){
		$ecommerce_watch_store_custom_css .='.toggle-nav i,.sidenav .closebtn, .left-menu .closebtn{';
	...
	if($ecommerce_watch_store_featured_image_box_shadow != false){
		$ecommerce_watch_store_custom_css .='.box-image img, #content-vw img{';
	...
	$ecommerce_watch_store_singlepost_image_box_shadow = get_theme_mod('ecommerce_watch_store_singlepost_image_box_shadow',0);
	if($ecommerce_watch_store_singlepost_image_box_shadow != false){
		$ecommerce_watch_store_custom_css .='.feature-box img{';
			$ecommerce_watch_store_custom_css .='box-shadow: '.esc_attr($ecommerce_watch_store_singlepost_image_box_shadow).'px '.esc_attr($ecommerce_watch_store_singlepost_image_box_shadow).'px '.esc_attr($ecommerce_watch_store_singlepost_image_box_shadow).'px #cccccc;';
		$ecommerce_watch_store_custom_css .='}';
	}

	$ecommerce_watch_store_related_image_box_shadow = get_theme_mod('ecommerce_watch_store_related_image_box_shadow',0);
	if($ecommerce_watch_store_related_image_box_shadow != false){
		$ecommerce_watch_store_custom_css .='.related-post .box-image img{';
			$ecommerce_watch_store_custom_css .='box-shadow: '.esc_attr($ecommerce_watch_store_related_image_box_shadow).'px '.esc_attr($ecommerce_watch_store_related_image_box_shadow).'px '.esc_attr($ecommerce_watch_store_related_image_box_shadow).'px #cccccc;';
		$ecommerce_watch_store_custom_css .='}';
	}

	/*---------------- Button Settings ------------------*/

	$ecommerce_watch_store_button_letter_spacing = get_theme_mod('ecommerce_watch_store_button_letter_spacing');
	...
	$ecommerce_watch_store_responsive_preloader_hide = get_theme_mod('ecommerce_watch_store_responsive_preloader_hide',false);
	if($ecommerce_watch_store_responsive_preloader_hide == true && get_theme_mod('ecommerce_watch_store_loader_enable',false) == false){
		$ecommerce_watch_store_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$ecommerce_watch_store_custom_css .='display:none !important;';
		$ecommerce_watch_store_custom_css .='} }';
	}

	if($ecommerce_watch_store_responsive_preloader_hide == false){
		$ecommerce_watch_store_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$ecommerce_watch_store_custom_css .='display:none !important;';
		$ecommerce_watch_store_custom_css .='} }';
	...
	$ecommerce_watch_store_resp_topbar = get_theme_mod( 'ecommerce_watch_store_resp_topbar_hide_show',false);
	if($ecommerce_watch_store_resp_topbar == true && get_theme_mod( 'ecommerce_watch_store_header_topbar', false) == false){
    	$ecommerce_watch_store_custom_css .='.topbar{';
			$ecommerce_watch_store_custom_css .='display:none;';
		$ecommerce_watch_store_custom_css .='} ';
	}
    if($ecommerce_watch_store_resp_topbar == true){
    	$ecommerce_watch_store_custom_css .='@media screen and (max-width:575px) {';
		$ecommerce_watch_store_custom_css .='.topbar{';
			$ecommerce_watch_store_custom_css .='display:block;';
		$ecommerce_watch_store_custom_css .='} }';
	}else if($ecommerce_watch_store_resp_topbar == false){
		$ecommerce_watch_store_custom_css .='@media screen and (max-width:575px) {';
		$ecommerce_watch_store_custom_css .='.topbar{';
			$ecommerce_watch_store_custom_css .='display:none;';
		$ecommerce_watch_store_custom_css .='} }';
	...
	$ecommerce_watch_store_breadcrumbs_alignment = get_theme_mod( 'ecommerce_watch_store_breadcrumbs_alignment','Left');
    if($ecommerce_watch_store_breadcrumbs_alignment == 'Left'){
    	$ecommerce_watch_store_custom_css .='@media screen and (min-width:768px) {';
		$ecommerce_watch_store_custom_css .='.breadcrumbs{';
			$ecommerce_watch_store_custom_css .='text-align:start;';
		$ecommerce_watch_store_custom_css .='}}';
	}else if($ecommerce_watch_store_breadcrumbs_alignment == 'Center'){
		$ecommerce_watch_store_custom_css .='@media screen and (min-width:768px) {';
		$ecommerce_watch_store_custom_css .='.breadcrumbs{';
			$ecommerce_watch_store_custom_css .='text-align:center;';
		$ecommerce_watch_store_custom_css .='}}';
	}else if($ecommerce_watch_store_breadcrumbs_alignment == 'Right'){
		$ecommerce_watch_store_custom_css .='@media screen and (min-width:768px) {';
		$ecommerce_watch_store_custom_css .='.breadcrumbs{';
			$ecommerce_watch_store_custom_css .='text-align:end;';
		$ecommerce_watch_store_custom_css .='}}';
	}
